...
**Da ZIP:**
1. Scarica lo ZIP corrispondente alla tua versione di QGIS dalla pagina [Releases](../../releases): `InSAR_Suite_v3.2.7_QGIS3.zip` per QGIS 3, `InSAR_Suite_v3.3.3_QGIS4.zip` per QGIS 4
...
**From ZIP:**
1. Download the ZIP matching your QGIS version from the [Releases](../../releases) page: `InSAR_Suite_v3.2.7_QGIS3.zip` for QGIS 3, `InSAR_Suite_v3.3.3_QGIS4.zip` for QGIS 4
